...
const CartPage = () => {
  ...
  const handleSaveOrder = async (orderData) => {
    try {
      const orderRef = await addDoc(collection(db, 'orders'), { ...orderData, status: 'pending' });
                  ...
                  <div className="flex gap-3 overflow-x-auto pb-1 scrollbar-hide snap-x snap-mandatory -mx-4 px-4">
                    {suggestions.map((p) => {
                      ...
                      return (
                        <div
                          key={p.id}
                          className="flex-shrink-0 snap-start w-[130px] rounded-xl overflow-hidden"
                          style={{
                            backgroundColor: '#F8FAFC',
                            border: '1px solid rgba(0,0,0,0.04)',
                          }}
                        >
                          ...
                          <div className="p-2 space-y-1">
                            ...
                            <p className="text-[10px] font-extrabold" style={{ color: '#FFB347' }}>
            ...
            <div className="lg:sticky lg:top-24 mt-6 lg:mt-0 space-y-4">
              <div className="bg-white rounded-xl p-5 shadow-sm space-y-4">
                <h3
                  ...
                  style={{ color: '#1A2238', borderBottom: '1px solid rgba(0,0,0,0.04)' }}
                >
                  Resumo da compra
                </h3>
                ...
                <div className="pt-2" style={{ borderTop: '1px solid rgba(0,0,0,0.04)' }}>
                  ...
                  {appliedCoupon ? (
                    <div
                      ...
                      style={{ backgroundColor: '#F8FAFC', border: '1px solid #FFB347' }}
                    >
                      <div>
                        <span className="text-sm font-bold" style={{ color: '#1A2238' }}>
                          {appliedCoupon.code}
                ...
                >
                  <span className="text-base font-bold" style={{ color: '#1A2238' }}>
                    Total
                  </span>
                  <span className="text-xl font-black" style={{ color: '#1A2238' }}>
                    {formatCurrency(total)}
                  </span>
                </div>
                <p className="text-xs text-center" style={{ color: '#94A3B8' }}>
                  ou 3x de {formatCurrency(total / 3)} sem juros
                </p>

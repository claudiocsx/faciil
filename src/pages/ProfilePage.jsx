...
const ProfilePage = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div>
        <h2 className="text-xl font-bold" style={{ color: '#1A2238' }}>
          Meu Perfil
        </h2>
        <p className="text-sm mt-1" style={{ color: '#94A3B8' }}>
          Gerencie suas informações e acompanhe o desempenho
        </p>
      </div>
      ...
      >
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
          <div
            className="w-20 h-20 rounded-xl flex items-center justify-center font-black text-2xl shrink-0"
          ...
          <div className="flex-1 text-center sm:text-left">
            <div className="flex items-center gap-2 justify-center sm:justify-start">
              {editing ? (
                ...
                <>
                  <h3 className="text-lg font-bold" style={{ color: '#1A2238' }}>
                    {user?.name}
                  </h3>
                  <button
            ...
            <div
              className="flex flex-col sm:flex-row items-center sm:items-center gap-3 mt-2 text-sm"
              style={{ color: '#94A3B8' }}
            >
              ...
              <span className="flex items-center gap-1.5">
                <Shield size={14} /> {roleLabels[user?.role] || user?.role}
              </span>
              <span className="hidden sm:block">•</span>
              <span className="flex items-center gap-1.5">
                <Calendar size={14} /> Desde {memberSince}
              </span>
            </div>
          </div>
        </div>
      ...
      >
        <div className="flex items-center gap-3 mb-3">
          <div
            ...
            style={{ backgroundColor: '#F0FFF4', color: '#10B981' }}
          >
            <Phone size={20} />
          </div>
          <div>
            <h3 className="font-bold text-sm" style={{ color: '#1A2238' }}>
              WhatsApp da Loja
            </h3>
            <p className="text-xs" style={{ color: '#94A3B8' }}>
              Número usado para receber pedidos
            </p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="px-4 py-2.5 rounded-lg font-bold text-sm transition-all hover:scale-105 flex items-center gap-2"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        >
          <div
            ...
            style={{ backgroundColor: '#FFF7ED', color: '#FFB347' }}
          >
            <ShoppingBag size={22} />
          </div>
          <div>
            <p className="text-2xl font-black" style={{ color: '#1A2238' }}>
              {totalOrders}
            </p>
            <p className="text-xs font-semibold uppercase" style={{ color: '#94A3B8' }}>
              Total de Pedidos
            </p>
          </div>
        </div>
      ...
      >
        <div className="p-5 border-b" style={{ borderColor: 'rgba(0,0,0,0.04)' }}>
          <h3 className="font-bold" style={{ color: '#1A2238' }}>
            Últimos Pedidos
          </h3>
        </div>
        {orders.length === 0 ? (

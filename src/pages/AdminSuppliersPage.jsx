  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={openNew}
          className="px-6 py-3 rounded-xl font-bold text-sm flex items-center gap-2 transition-all hover:shadow-lg"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          >
            <div className="flex items-start justify-between mb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-bold text-sm" style={{ color: '#1A2238' }}>
                    {s.name}
                  </h4>
                </div>
              </div>
        ...
        {suppliers.length === 0 && (
          <p className="text-center col-span-3 py-12 text-sm" style={{ color: '#94A3B8' }}>

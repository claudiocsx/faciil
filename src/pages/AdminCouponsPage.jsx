        ...
        <form onSubmit={handleSubmit} className="glass-card p-4 rounded-xl space-y-3">
          ...
          <div className="flex gap-2 pt-2">
            <button
              ...
              className="flex-1 py-2 rounded-lg text-xs font-bold glass-card text-text-secondary"
            >
              Cancelar
            </button>
            <button
          ...
          >
            <div className="flex-1">
              <div className="flex items-center gap-2">
                ...
                <span
                  className={`px-1.5 py-0.5 rounded text-xs font-bold ${coupon.active ? 'text-text-dim' : 'bg-red-500/10 text-red-400'}`}
                >

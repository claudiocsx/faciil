  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4" style={{ backgroundColor: '#050505' }}>
      ...
      <div className="text-center max-w-md relative">
        <div className="w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6 drop-shadow-[0_0_12px rgba(29,242,255,0.6)]" style={{ backgroundColor: 'rgba(29,242,255,0.05)' }}>
          <Logo size={80} />
        </div>
        ...
        <button
          ...
          style={{ backgroundColor: '#1DF2FF', boxShadow: '0 0 12px rgba(29,242,255,0.5)' }}
        >

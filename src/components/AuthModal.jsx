...
const AuthModal = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ backgroundColor: 'rgba(5,5,5,0.85)', backdropFilter: 'blur(8px)' }}>
      <div className="w-full max-w-md rounded-2xl" style={{ backgroundColor: '#0A0A0A', border: '1px solid rgba(29,242,255,0.15)', boxShadow: '0 0 30px rgba(29,242,255,0.1), 0 25px 50px rgba(0,0,0,0.5)' }}>
        <div className="p-6 border-b" style={{ borderColor: 'rgba(29,242,255,0.1)' }}>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <button
            ...
            style={{ backgroundColor: '#1DF2FF', boxShadow: '0 0 12px rgba(29,242,255,0.5), 0 0 24px rgba(29,242,255,0.2)' }}
          >
            {loading ? (
        ...
        <div className="p-6 border-t text-center" style={{ borderColor: 'rgba(29,242,255,0.1)' }}>

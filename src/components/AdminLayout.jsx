            ...
            {menuItems.map((item) => {
              ...
              return (
                <button
                  ...
                  style={active ? { backgroundColor: 'rgba(0,212,255,0.1)', color: '#00D4FF', border: '1px solid rgba(0,212,255,0.2)' } : { color: 'var(--color-text-secondary)', backgroundColor: 'transparent', border: '1px solid transparent' }}
              ...
              {menuItems.map((item) => {
                ...
                return (
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-xl transition-all"
                    style={active ? { backgroundColor: 'rgba(0,212,255,0.1)', color: '#00D4FF' } : { color: 'var(--color-text-secondary)' }}
                  >
                    <Icon size={18} />
                    {item.label}
                  </button>
          ...
          <div className="flex items-center justify-between h-full">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                style={{ backgroundColor: '#00D4FF', boxShadow: '0 0 8px rgba(0,212,255,0.3)' }}
              >
                <Store size={16} />
                Ver Loja
              </button>

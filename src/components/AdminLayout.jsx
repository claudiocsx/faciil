  ...
  return (
    <div className="min-h-screen flex" style={{ backgroundColor: '#FDFDFD' }}>
      ...
      >
        <div className="flex flex-col h-full">
          ...
          >
            ...
            >
              <Logo size={36} />
              <span className="font-black text-2xl" style={{ color: '#1A2238' }}>
                faciil
              </span>
            </button>
          </div>
          ...
          <div className="p-4" style={{ borderBottom: '1px solid rgba(0,0,0,0.04)' }}>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs font-bold uppercase" style={{ color: '#94A3B8' }}>
                  {user?.role}
                </p>
              </div>
            </button>
          ...
          <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
            <p
              className="px-3 text-xs font-black uppercase tracking-widest mb-3"
              style={{ color: '#94A3B8' }}
            >
              Menu
            </p>
            ...
            <div className="flex flex-col h-full">
              ...
              >
                <div className="flex items-center gap-3">
                  <Logo size={32} />
                  <span className="font-black text-xl" style={{ color: '#1A2238' }}>
                    faciil
                  </span>
                </div>
                <button
                  ...
                  {menuItems.map((item) => {
                    ...
                    return (
                      <button
                        ...
                        style={
                          active
                            ? { backgroundColor: 'rgba(255,179,71,0.15)', color: '#FFB347' }
                            : { color: '#4A5568' }
                        }
                      >
                        <Icon size={18} />
      ...
      <div className="flex-1 flex flex-col">
        <header
          className="sticky top-0 z-30 h-16 px-4 lg:px-6 bg-white/80 backdrop-blur-md"

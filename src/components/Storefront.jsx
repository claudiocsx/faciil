...
const ACCESS_CARDS = [
  {
    icon: Truck,
    title: 'Frete grátis',
    desc: 'Entregas via Uber Flash em Crato - CE. Consulte prazos.',
  },
  {
    icon: ShoppingBag,
    title: 'Menos de R$100',
    desc: 'Produtos com preços imperdíveis para você.',
  },
  {
    icon: CreditCard,
    title: 'Meios de pagamento',
    desc: 'Pague com cartão, PIX ou dinheiro na entrega.',
  },
...
const Storefront = ({
  ...
  const flashProducts = useMemo(
    () =>
      products.filter(
        (p) =>
          p.flashSale?.endsAt &&
          new Date(p.flashSale.endsAt) > new Date() &&
          !expiredFlashIds.has(p.id)
      ),
    ...
    const loadCategories = async () => {
      try {
        ...
        if (cats.length > 0) {
          ...
          const catIcons = {};
          cats.forEach((c) => {
            catIcons[c.name] = c.icon || 'default';
          });
  ...
  const filteredProducts = useMemo(() => {
    let result = products.filter((p) => {
      const catMatch =
        selectedCategories.includes('Tudo') || selectedCategories.includes(p.category);
  ...
  const renderFilterContent = () => (
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="space-y-1">
          {categories.map((cat) => (
            <label
              key={cat}
              className="flex items-center gap-2 px-2 py-1.5 rounded-lg cursor-pointer hover:bg-black/5 transition-colors"
            >
              <input
                type="checkbox"
              ...
              />
              <span className="text-sm text-text-primary" style={{ color: '#475569' }}>
                {cat}
              </span>
            </label>
          ))}
      ...
      {(selectedCategories.length !== 1 ||
        !selectedCategories.includes('Tudo') ||
        priceRange.min !== '' ||
        priceRange.max !== '' ||
        searchTerm) && (
        <button
  ...
  const testimonials = [
    {
      name: 'João Silva',
      text: 'Produto chegou super rápido pelo Uber Flash! Qualidade excelente.',
      rating: 5,
    },
    {
      name: 'Maria Oliveira',
      text: 'Comprei um smartwatch e amei. Atendimento nota 10!',
      rating: 5,
    },
    {
      name: 'Carlos Santos',
      text: 'Melhor loja de acessórios do Crato. Preço justo e entrega rápida.',
      rating: 5,
    },
    {
      name: 'Ana Ferreira',
      text: 'Fone Bluetooth incrível! Superou minhas expectativas.',
      rating: 4,
    },
    ...
    <div className="min-h-screen grid-bg" style={{ backgroundColor: '#ebebeb' }}>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex items-center justify-between h-14 lg:h-16 gap-2 lg:gap-4">
            ...
            >
              <Logo size={20} />
              <span
                className="font-black text-base lg:text-xl tracking-tight"
                style={{ color: '#1A2238' }}
              >
                fac<span style={{ color: '#FFB347', letterSpacing: '-1px' }}>ii</span>l
              </span>
            </button>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs font-bold" style={{ color: '#FFB347' }}>
                              R$ {p.price?.toFixed(2)}
                            </p>
                          </div>
                        </button>
            ...
            <div className="flex items-center gap-1 lg:gap-2">
                ...
                <div className="relative">
                  ...
                  {userDropdownOpen && (
                    <>
                      ...
                      />
                      <div
                        className="absolute right-0 top-full mt-2 w-48 bg-white rounded-xl shadow-2xl py-2 z-40 border"
              ...
              >
                ...
                {cart.reduce((sum, item) => sum + item.quantity, 0) > 0 && (
                  <span
                    className="absolute -top-1 -right-1 w-4 h-4 lg:w-5 lg:h-5 text-[10px] lg:text-xs font-bold rounded-full flex items-center justify-center"
          ...
          <div className="hidden lg:flex items-center gap-4 text-xs pb-2 pt-2 border-t border-gray-100">
            <div
              className="flex items-center gap-1 cursor-pointer hover:text-gray-900 shrink-0"
              style={{ color: '#64748B' }}
            >
            ...
            <button
              ...
              className="hover:text-[#1A2238] transition-colors font-medium"
              style={{ color: '#64748B' }}
            >
              Categorias
            </button>
      ...
      <section className="relative overflow-hidden w-full" style={{ backgroundColor: '#1A2238' }}>
        <div className="relative min-h-[200px] md:min-h-[60vh] lg:min-h-[500px]">
            ...
            {heroSlides.map((item, idx) => (
              ...
              >
                ...
                <div
                  ...
                  style={{ backgroundColor: 'rgba(255,179,71,0.2)' }}
                ></div>
                <div
                ...
                ></div>
                <div
                  className="absolute top-[20%] right-[35%] w-32 h-32 rounded-full blur-2xl"
                ...
                {item.type === 'banner' && (
                  <div
                    ...
                    style={{
                      background:
                        'linear-gradient(to right, rgba(26,34,56,0.7) 0%, rgba(26,34,56,0.2) 50%, transparent 70%)',
                    }}
                  />
                )}
                ...
                <div className="max-w-7xl mx-auto px-4 w-full h-full relative z-10">
                  {item.type === 'banner' ? (
                    <div
                      ...
                      onClick={() => {
                        if (item.productId) navigate(`/produto/${item.productId}`);
                      }}
                    >
                      {(item.title || item.subtitle) && (
                        <div className="max-w-lg px-4">
                          ...
                          {item.productName && (
                            <span
                              className="inline-block mt-3 px-4 py-2 rounded-lg font-bold text-xs md:text-sm"
                              style={{ backgroundColor: '#FFB347', color: '#1A2238' }}
                            >
                              Ver Produto
                            </span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 items-center h-full gap-6">
                        ...
                        {(() => {
                          ...
                          return img && !img.startsWith('blob:') ? (
                            <>
                              ...
                              {discount > 0 && (
                                <div
                                  className="absolute -top-2 -right-2 sm:-top-4 sm:-right-4 flex items-center gap-1 px-2 sm:px-3 py-1 sm:py-1.5 rounded-full shadow-lg border-2 border-white text-[10px] sm:text-xs font-black uppercase tracking-wider"
                                  style={{ backgroundColor: '#FFB347', color: '#1A2238' }}
                                >
                                  <Percent size={10} />
                                  <span>-{discount}%</span>
                            ...
                            <div
                              className="relative z-10 w-40 sm:w-64 h-40 sm:h-64 flex items-center justify-center rounded-full"
                              style={{ backgroundColor: 'rgba(255,255,255,0.05)' }}
                            >
                      ...
                      <div className="text-center md:text-left order-1 md:order-2">
                        <span
                          className="inline-flex items-center gap-1 px-3 py-1 rounded-full border text-[10px] font-bold uppercase tracking-widest mb-3"
                          style={{
                    ...
                    <>
                      <div
                        ...
                        style={{
                          background:
                            'linear-gradient(135deg, #1A2238 0%, #2A3A5C 50%, #1A2238 100%)',
                        }}
                      />
                      <div
                        className="absolute inset-0"
                        style={{
                          background:
                            'radial-gradient(circle at 80% 30%, rgba(255,179,71,0.15) 0%, transparent 60%)',
                        }}
                      />
                      <div className="relative z-10 flex items-center justify-center h-full">
                        <div className="text-center">
                          ...
                          <p
                            className="text-lg sm:text-xl md:text-2xl font-bold mt-1 mb-3"
                            style={{ color: '#FFB347' }}
                          >
                            {item.discount}
                          </p>
                          <button
                            onClick={() => {
                              ...
                              setToastMessage(`Cupom ${item.code} copiado!`);
                            }}
          ...
          {heroSlides.length > 1 && (
            <>
              <button
                ...
                className="absolute left-4 top-1/2 -translate-y-1/2 z-20 w-10 h-10 flex items-center justify-center rounded-full transition-all hover:scale-110"
                style={{
              ...
              <button
                ...
                className="absolute right-4 top-1/2 -translate-y-1/2 z-20 w-10 h-10 flex items-center justify-center rounded-full transition-all hover:scale-110"
                style={{
                  backgroundColor: 'rgba(255,255,255,0.2)',
                  backdropFilter: 'blur(8px)',
                  color: '#FFFFFF',
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(to top, #FDFDFD 0%, rgba(255,179,71,0.06) 40%, transparent 100%)',
            }}
          />
          <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-1.5 z-20">
            {heroSlides.map((_, i) => (
              <button
                ...
                style={{
                  backgroundColor: i === currentSlide ? '#FFB347' : 'rgba(255,255,255,0.4)',
                }}
              />
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          ...
          <div className="flex md:hidden gap-3 overflow-x-auto pb-1 scrollbar-hide snap-x snap-mandatory -mx-4 px-4">
            {ACCESS_CARDS.map((card, i) => (
              ...
              >
                ...
                <span className="text-[11px] font-bold leading-tight" style={{ color: '#1A2238' }}>
                  {card.title}
                </span>
              </div>
            ))}
          ...
          <div className="hidden md:grid md:grid-cols-3 lg:grid-cols-6 gap-3">
            {ACCESS_CARDS.map((card, i) => (
              ...
              >
                <h4
                  className="text-sm font-semibold leading-snug w-full text-left pb-2 border-b border-gray-100 transition-colors group-hover:text-[#1A2238]"
                  style={{ color: '#1A2238' }}
                >
                  {card.title}
                </h4>
      ...
      {flashProducts.length > 0 && (
        <section
          ...
          style={{ backgroundColor: '#FEF2F2', borderBottom: '1px solid rgba(239,68,68,0.1)' }}
        >
          <div className="max-w-7xl mx-auto px-4 lg:px-8">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-sm sm:text-lg font-black" style={{ color: '#1A2238' }}>
                  Ofertas Relâmpago
                </h2>
              </div>
            </div>
                    ...
                    <div className="p-2.5 sm:p-3 space-y-1">
                      ...
                      <div className="flex items-baseline gap-2 pt-1">
                        ...
                        <p className="text-[10px] line-through" style={{ color: '#94A3B8' }}>
                          De: R$ {p.price.toFixed(2)}
                        </p>
                      </div>
                      {p.flashSale?.endsAt && (
                        <div className="flex items-center gap-1 pt-1">
                          <CountdownTimer
                            endsAt={p.flashSale.endsAt}
                            onExpired={() => setExpiredFlashIds((prev) => new Set([...prev, p.id]))}
                          />
                        </div>
                      )}
                      {p.comingSoon ? (
                        ...
                        <button
                          onClick={(e) => {
                            ...
                            if (p.stock === 0) return;
                            onAddToCart(p);
                            setToastMessage('Produto adicionado!');
                            setToastVisible(true);
                          }}
                          disabled={p.stock === 0}
      ...
      {offerProducts.length > 0 && (
        <section
          id="ofertas"
          className="py-6 sm:py-8"
          style={{ backgroundColor: '#F5F3F0', borderBottom: '1px solid rgba(0,0,0,0.04)' }}
        >
          <div className="max-w-7xl mx-auto px-4 lg:px-8">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
            ...
            <div
              ref={offerScrollRef}
              className="flex gap-3 sm:gap-4 overflow-x-auto pb-2 scrollbar-hide scroll-smooth snap-x snap-mandatory -mx-4 px-4"
            >
              {offerProducts.map((p) => {
                const img = p.image || p.images?.[0];
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <span
                        className="absolute top-2 left-2 sm:top-3 sm:left-3 px-2.5 py-1 rounded-full text-[10px] font-black z-10"
                        style={{ backgroundColor: '#FFB347', color: '#1A2238' }}
                      >
                        -{discount}%
                      </span>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 lg:px-8 py-3">
          <div className="flex flex-nowrap items-center gap-1.5 sm:gap-2 overflow-x-auto pb-2 scrollbar-hide scroll-smooth snap-x snap-mandatory -mx-4 px-4">
            {categories.map((cat) => {
              const IconComponent =
                ICONS_MAP[cat] || ICONS_MAP[categoryIcons[cat]] || ICONS_MAP.default;
              const isSelected =
                selectedCategories.includes(cat) &&
                (cat === 'Tudo'
                  ? selectedCategories.length === 1 || selectedCategories.includes('Tudo')
                  : true);
              return (
                <button
                  key={cat}
              ...
              <div className="flex items-center gap-2 mb-6 flex-wrap">
                ...
                {!selectedCategories.includes('Tudo') &&
                  selectedCategories.map((cat) => (
                    ...
                    >
                      {cat}
                      <button onClick={() => toggleCategory(cat)} className="hover:opacity-60 ml-1">
                        ×
                      </button>
                    </span>
                  ))}
                {searchTerm && (
                  <span
                    className="px-3 py-1 rounded-full text-xs font-bold flex items-center gap-1"
                    style={{
                      backgroundColor: 'rgba(90,158,90,0.15)',
                      color: '#1A2238',
                      border: '1px solid rgba(90,158,90,0.3)',
                    }}
                  >
                    Busca: "{searchTerm}"
                    <button onClick={() => setSearchTerm('')} className="hover:opacity-60 ml-1">
                      ×
                    </button>
                  </span>
                )}
                {(priceRange.min !== '' || priceRange.max !== '') && (
                  <span
                    className="px-3 py-1 rounded-full text-xs font-bold flex items-center gap-1"
                    style={{
                      backgroundColor: 'rgba(59,139,185,0.15)',
                      color: '#1A2238',
                      border: '1px solid rgba(59,139,185,0.3)',
                    }}
                  >
                    Preço: {priceRange.min ? `R$${priceRange.min}` : '0'} -{' '}
                    {priceRange.max ? `R$${priceRange.max}` : '∞'}
                    <button
            ...
            {products.length === 0 ? (
              ...
              <div className="text-center py-16 space-y-4">
                <div
                  ...
                  style={{ backgroundColor: 'rgba(255,179,71,0.05)' }}
                >
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8 py-12 md:py-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
            <div>
              ...
              <p className="text-sm leading-relaxed" style={{ color: '#94A3B8' }}>
                Acessórios tech com entrega rápida via Uber Flash. Sua escolha inteligente em
                tecnologia.
              </p>
              ...
              <ul className="space-y-3">
                {['Produtos', 'Ofertas', 'Pedidos', 'Sobre'].map((item) => (
                  <li key={item}>
                    <a
                      href="#"
                      className="text-sm transition-colors hover:text-[#FFB347]"
                      style={{ color: '#94A3B8' }}
                    >
                      {item}
                    </a>
          ...
          >
            <p className="text-xs" style={{ color: '#64748B' }}>
              © 2026 Faciil. Todos os direitos reservados.
            </p>
      ...
      {mobileSearchOpen && (
        <>
          ...
          />
          <div
            className="fixed top-0 left-0 right-0 z-50 p-4 md:hidden bg-white shadow-lg"
                  ...
                  {suggestions.map((p) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-medium truncate" style={{ color: '#1A2238' }}>
                            {p.name}
                          </p>
                          <p className="text-xs font-bold" style={{ color: '#FFB347' }}>
                            R$ {p.price?.toFixed(2)}
